export const products = [
    {
        id: 1,
        title: 'Loft stílusú szék',
        image: 'https://grandrapidschair.com/wp-content/uploads/2016/01/250_Brady_Graphite_Honey-1.jpg',
        category: 1,
        price: '15 000 Ft.',
        description: 'A Loft stílusú szék a modern és ipari design tökéletes kombinációja, amely azonnal vonzza a figyelmet bármely szoba berendezésében. Ezt a különleges széket a letisztult vonalak, a letisztult színek és az elegáns anyagok jellemzik, amelyek együttesen egyedülálló stílust kölcsönöznek neki.'
    },
    {
        id: 2,
        title: 'Fa mini asztal',
    ...
    {
        id: 4,
        title: 'Mintás fotel lábtartóval',
